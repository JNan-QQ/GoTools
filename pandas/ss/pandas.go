...
//func Read(path string, sType map[string]series.Types, sheet ...string) DataFrame {
//
//	// 设置默认读取工作部名称
//	if sheet == nil {
...
//		}
//		return series.New(newElems, elems.Types(), elems.Name)
//	})
//
//	// 更新数据集
...
//func (d *DataFrame) SetType(t map[string]series.Types) {
//
//	if t == nil {
//		return
//	}
